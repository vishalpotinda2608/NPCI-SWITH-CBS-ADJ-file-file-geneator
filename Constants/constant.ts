...
export const merchantVPAs=[
    ...
    'gaming.car@timecosmos',
    'gaming.bike@timecosmos',
    'gaming.truck@timecosmos',
    'gaming.boat@timecosmos',
    'gaming.airplane@timecosmos',
    'gaming.scooter@timecosmos',
    'gaming.helmet@timecosmos',
    'gaming.robot@timecosmos',
    'gaming.submarine@timecosmos',
    'gaming.drone@timecosmos',

    //Fast Food Restaurants-5814
    'dining.pizza@timecosmos',
    'dining.burger@timecosmos',
    'dining.sushi@timecosmos',
    'dining.pasta@timecosmos',
    'dining.tacos@timecosmos',
    'dining.soup@timecosmos',
    'dining.salad@timecosmos',
    'dining.steak@timecosmos',
    'dining.dessert@timecosmos',
    'dining.vegetarian@timecosmos',

    // Grocery Stores, Supermarkets-5411
    'grocery.freshmart@timecosmos',
    'grocery.marketplace@timecosmos',
    'grocery.sbmrite@timecosmos',
    'grocery.foodland@timecosmos',
    'grocery.greenbasket@timecosmos',
    'grocery.dailygrocer@timecosmos',
    'grocery.bulkstore@timecosmos',
    'grocery.organic@timecosmos',
    'grocery.corner@timecosmos',
    'grocery.town@timecosmos',

    // Travel Agencies - 4722
    'travel.explore@timecosmos',
    'travel.wander@timecosmos',
    'travel.adventure@timecosmos',
    'travel.getaway@timecosmos',
    'travel.destinations@timecosmos',
    'travel.escape@timecosmos',
    'travel.vacation@timecosmos',
    'travel.tour@timecosmos',
    'travel.globetrot@timecosmos',
    'travel.expedition@timecosmos',

    // Telecommunication Services-4814
   'telecom.mobile@timecosmos',
    'telecom.internet@timecosmos',
    'telecom.cable@timecosmos',
    'telecom.voip@timecosmos',
    'telecom.fiber@timecosmos',
    'telecom.data@timecosmos',
    'telecom.broadband@timecosmos',
    'telecom.satellite@timecosmos',
    'telecom.wireless@timecosmos',
    'telecom.convergence@timecosmos'
]

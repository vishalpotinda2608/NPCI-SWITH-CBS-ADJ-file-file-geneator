...
var generateDataForDateRange = function (startDate, numberOfDays, monthName) {
    ...
    var _loop_1 = function (date) {
        ...
        writeDataToCSV("".concat(monthName, "/").concat(filenameDate, "/TIMEOUT_DATA/UPI Time Out Cases Report_SBL_").concat(cbsFormatteTimeoutFile, ".csv"), constant_1.timeoutHeaders, function () { return (0, timeout_1.generateTimeoutData)(ROW_DATA, cbsFormattedDate, commonData); });
    };
...
// Usage example
var startDate = new Date(2024, 10, 22); // 7 - Aug

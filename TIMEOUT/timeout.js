...
exports.generateTimeoutData = generateTimeoutData;
var faker_1 = require("@faker-js/faker");
var constant_1 = require("../Constants/constant");
//NPCI
function generateTimeoutData(count, date, commonData) {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, {
                        ...
                        "TXN Type": "U2",
                        "TXN Date": date,
                        "TXN Time": (0, constant_1.generateRandomTimeHHMMSS)(),
                        "Settlement Date": date,
                        "Response Code": "RB",
                        RRN: RRN,
                        STAN: "".concat(faker_1.faker.string.numeric(12)),
                        Remitter: faker_1.faker.helpers.arrayElement(constant_1.beneficiaryTypes),
